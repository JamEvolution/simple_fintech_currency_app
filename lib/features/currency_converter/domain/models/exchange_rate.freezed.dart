...
abstract class $ExchangeRateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String base, DateTime date, Map<String, double> rates});
}
...
class _$ExchangeRateImpl implements _ExchangeRate {
  ...
  int get hashCode => Object.hash(
      runtimeType, base, date, const DeepCollectionEquality().hash(_rates));
...
abstract class _ExchangeRate implements ExchangeRate {
  const factory _ExchangeRate(
      ...
      required final Map<String, double> rates}) = _$ExchangeRateImpl;
